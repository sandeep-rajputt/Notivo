const ResetPassword = (resetLink: string): string => {
  ...
  return `
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: #fff; border-radius: 10px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); padding: 30px;">
          ...
          <div style="text-align: center; margin-bottom: 20px;">
            <h2 style="color: #6a49f2; font-size: 28px; font-weight: bold; margin-bottom: 10px;">Reset Your Password</h2>
            <p style="color: #3e3f66; font-size: 16px; margin: 0;">It looks like you requested to reset your password. Let’s get you a new one!</p>
          </div>
          
          <!-- Reset Password Button -->
          <div style="text-align: center; margin-top: 30px;">
            <a href="${resetLink}" style="background-color: #6a49f2; color: #ffffff; padding: 14px 28px; border-radius: 50px; font-size: 18px; font-weight: bold; text-decoration: none; display: inline-block;">
              Reset Your Password
            </a>
          </div>
          ...
          <div style="text-align: center; margin-top: 20px; font-size: 14px; color: #ff7438;">
            <p>This link will expire in 3 hours. Please reset your password before then!</p>
          </div>
